	...
	(if en
		(progn
			(setq 
				...
				ls1 (ssget "x" (list '(-4 . "<or")
						'(-4 . "<and") '(0 . "line") (cons 10 pt1) '(-4 . "and>")
						'(-4 . "<and") '(0 . "line") (cons 11 pt1) '(-4 . "and>")
					'(-4 . "or>")))
				ls2 (ssget "x" (list '(-4 . "<or")
						'(-4 . "<and") '(0 . "line") (cons 10 pt2) '(-4 . "and>")
						'(-4 . "<and") '(0 . "line") (cons 11 pt2) '(-4 . "and>")
					'(-4 . "or>")))
